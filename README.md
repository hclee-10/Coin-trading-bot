...
| **전략 경쟁** | 64개 전략이 같은 시세로 동시에 모의매매한 실시간 순위표. 승률 0% 전략 숨기기 필터 |
...
| `dca_atr` | ⚠️ 무매도 적립식(관찰용) — 급변 기준 ATR×2. 급등엔 숏, 급락엔 롱을 고정 금액으로 사 모으기만 한다 |
| `dca_pct` | ⚠️ 무매도 적립식(관찰용) — 급변 기준 고정 1.5% |
| `dca_channel` | ⚠️ 무매도 적립식(관찰용) — 급변 기준 20봉 고저 돌파 |
